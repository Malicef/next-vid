...
export default function Home() {
  ...
  return (
    <main className="w-screen h-screen bg-pink-100 flex justify-center items-center p-8 gap-8 font-sans">
      {/* Coluna da Playlist */}
      <div className="flex flex-col w-[350px] h-[80vh] bg-pink-200 p-4 rounded-lg shadow-lg">
        <h2 className="text-rose-900 text-xl font-bold mb-4 px-2">Playlist</h2>
        <div className="flex-grow overflow-y-auto pr-2">
          {videos.map((video, index) => (
            ...
            >
              ...
              />
              <h3 className="text-rose-900 font-semibold text-sm">
                {video.description}
              </h3>
            </button>
          ))}
      ...
      {/* Coluna do Player */}
      <div className="flex flex-col items-center justify-center bg-pink-200 rounded-2xl shadow-lg p-6 w-[560px]">
        <video
          ref={videoRef}
        ...
        {/* Controles */}
        <div className="w-full mt-4 text-rose-900">
          ...
          <div className="flex justify-between pad-4 items-center mt-2">
            <div className="flex items-center gap-2 w-1/3">
              ...
              <input
                ...
                className="w-24 h-2 bg-pink-300 rounded-lg appearance-none cursor-pointer accent-pink-500"
              />
            </div>
